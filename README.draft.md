...
> **Init is async.** Listen for `ready` / `error` *before* calling `init()` — see [docs/lifecycle.md](docs/lifecycle.md) for the full pattern and graceful shutdown.
...
| **Lifecycle & hooks** | `init` / `shutdown` + `onLogFailure`, `onTransportError` | [docs/lifecycle.md](docs/lifecycle.md) |
...
- **[Lifecycle & observability hooks](docs/lifecycle.md)**
- **[Runtime reconfiguration](docs/runtime-reconfiguration.md)**
- **[Native addon (Rust)](docs/native-addon.md)**
- **[Examples repository](https://github.com/Syntropysoft/syntropylog-examples)** — runnable examples 01–17
- **[Benchmark report](doc-es/benchmark-memory-run.md)** — throughput + memory (ES)
