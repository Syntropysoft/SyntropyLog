...
import {
  ISerializer,
  SerializationContext as SerializerContext,
...
describe('SerializationStep', () => {
  ...
  describe('Serialization Execution', () => {
    it('should serialize data successfully', () => {
      ...
      const result = step.execute({ id: 1, name: 'test' }, context);
    ...
    it('should return raw data if no serializer matches (resilience)', () => {
    ...
    it('should measure serialization duration accurately', () => {
      ...
      const result = step.execute({ id: 1 }, context);
  ...
  describe('Serializer Selection', () => {
    it('should select first matching serializer by priority', () => {
      const lowPrioritySerializer: ISerializer = {
        name: 'low-priority',
        priority: 10,
        canSerialize: vi.fn().mockReturnValue(true),
