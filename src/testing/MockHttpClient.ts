...
export class MockHttpClient implements IHttpClientAdapter {
  ...
  constructor(spyFn?: (implementation?: any) => any) {
    ...
    this.request = this.createMock()
      .mockImplementation(async (request: AdapterHttpRequest) => {
    ...
    this.get = this.createMock()
      .mockImplementation(async (url: string, headers?: Record<string, any>) => {
        return this.request({
          url,
          method: 'GET',
          headers: headers || {}
    ...
    this.post = this.createMock()
      .mockImplementation(async (url: string, body?: any, headers?: Record<string, any>) => {
        return this.request({
          url,
          method: 'POST',
          headers: headers || {},
    ...
    this.setResponse = this.createMock()
      .mockImplementation((method: string, response: AdapterHttpResponse<any>) => {
    ...
    this.setTimeout = this.createMock()
      .mockImplementation((method: string, timeoutMs: number) => {
        ...
        this.request.mockImplementation(async (req: AdapterHttpRequest) => {
          if (req.method.toUpperCase() === method.toUpperCase() && this.timeouts.has(method)) {
  ...
  private updateMethodImplementations() {
    this.get.mockImplementation(async (url: string, headers?: Record<string, any>) => {
      return this.request({
        url,
        method: 'GET',
        headers: headers || {}
    ...
    this.post.mockImplementation(async (url: string, body?: any, headers?: Record<string, any>) => {
      return this.request({
        url,
        method: 'POST',
        headers: headers || {},
    ...
    this.put.mockImplementation(async (url: string, body?: any, headers?: Record<string, any>) => {
      return this.request({
        url,
        method: 'PUT',
        headers: headers || {},
    ...
    this.delete.mockImplementation(async (url: string, headers?: Record<string, any>) => {
      return this.request({
        url,
        method: 'DELETE',
        headers: headers || {}
    ...
    this.patch.mockImplementation(async (url: string, body?: any, headers?: Record<string, any>) => {
      return this.request({
        url,
        method: 'PATCH',
        headers: headers || {},
