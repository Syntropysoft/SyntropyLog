...
const maskingPolicy = {
  ...
  rules: [
    {
      pattern: /password|token|secret|cvv|pincode/i,
    ...
    },
    {
      ...
      customMask: (val: string) => 'XX-XXXX-X',
    },
  ],
};
...
export async function initLegacyBridge(
  dbExecutor: (data: any) => Promise<void>
) {
...
export const appLogger = {
  info: (msg: string, meta?: any) =>
    syntropyLog.getLogger('app').info(msg, meta),
  warn: (msg: string, meta?: any) =>
    syntropyLog.getLogger('app').warn(msg, meta),
  error: (msg: string, meta?: any) =>
    syntropyLog.getLogger('app').error(msg, meta),
 ...
 * });
 *
 * appLogger.audit('User Login Attempt', { userId: 'u123', ip: '127.0.0.1' });
 */
